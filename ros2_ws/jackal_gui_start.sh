...
export ROS_DOMAIN_ID=42 # Eine beliebige Zahl zwischen 1-100, um Kollisionen zu vermeiden
...
# Robot State Publisher (EXTREM WICHTIG: Erzeugt die base_link -> laser Transformation)
# Ohne Sim Time wackelt der Laser in RViz
